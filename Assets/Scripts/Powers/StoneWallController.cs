...
public class StoneWallController : CrosshairPower
{
    ...
    public static Action<int, float, float, PowerTypes, DamageTypes, float, float> OnWallSummon;
    ...
    protected override void Shoot()
    {
        if (isActive)
        {
            ...
            OnWallSummon(hitpoints, duration, damage, powerType, damageType, shakeDuration, shakeIntensity);
            base.Shoot();
        }
    }
}
